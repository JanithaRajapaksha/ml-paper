...
% TODO: Export one compact EDA figure from the notebook to paper/figures and
% include it here. Every figure should be discussed in the surrounding text.
...
% TODO: Export and include an actual-versus-predicted or residual figure from
% the notebook. Refer to the figure explicitly and discuss visible error patterns.
